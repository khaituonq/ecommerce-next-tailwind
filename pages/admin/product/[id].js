...
export default function AdminProductEditScreen() {
    ...
    const submitHandler = async ({ name, slug, price, category, image, brand, countInStock, description, rating }) => {
        try {
                ...
                <div className="md:col-span-3">
                    {loading ? (
                        ...
                        <form className="mx-auto max-w-screen-md" onSubmit={handleSubmit(submitHandler)}>
                            <h1 className="mb-4 text-xl uppercase font-medium">{`Edit Product ${productId.substring(
                                20,
                            )}`}</h1>
                            <div className="mb-4">
                            ...
                            <div className="mb-4">
                                <label htmlFor="countInStock">Rating</label>
                                <input
                                    type="text"
                                    className="w-full"
                                    id="rating"
                                ...
                                />
                                {errors.rating && <div className="text-red-500">{errors.rating.message}</div>}
                            </div>
                            <div className="mb-4 flex justify-between">
                                <button disabled={loadingUpdate} className="primary-button">
                                    {loadingUpdate ? 'Loading' : 'Update'}
                                </button>
                                <div className="mb-4 default-button uppercase">
